#!/usr/bin/env python3
"""Run the 475 NL-to-lifted-LTLf translation calls over the sealed worklist.

The runner writes one canonical eleven-field record per translation identifier,
resumes by skipping recorded identifiers, and restricts semantic retries to the
public retry prompt builders. Model messages contain only the rendered system
prompt and public user prompt; hidden construction and validation fields are
excluded by a fail-closed leak guard.
"""
