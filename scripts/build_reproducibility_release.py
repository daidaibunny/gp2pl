...
- `certificate_challenge_summary.json` records fail-closed and renaming challenges.
...
Each method-case key has one final scientific outcome. SHA-256 values in the
manifest establish released-file integrity.
"""
