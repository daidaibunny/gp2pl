...
Examples:
  ...
  python src/main.py compile-moose-atomic-library --policy-file <policy.readable> --domain-file src/domains/blocksworld-tower/domain.pddl --domain-name blocksworld-tower --validated-policy-lifting
  python src/main.py append-lifted-temporal-goal --domain-file src/domains/blocksworld-tower/domain.pddl --ltlf-goal-json <validated-lifted-ltlf.json> --query-id query_1
  python src/main.py validate-jason-plan-library --domain-file src/domains/ferry/domain.pddl --problem-file src/domains/ferry/test/p0_01.pddl --goal-name g_ferry_query_1
		""",
	)
	...
	moose_parser.add_argument(
		"--domain-file",
		help="PDDL domain file. Required for validated policy lifting.",
	)
	moose_parser.add_argument(
		"--minimal-modules",
		action="store_true",
	...
	jason_parser.add_argument(
		"--goal-name",
		required=True,
		help="Top-level AgentSpeak achievement goal to run, for example g_ferry_query_1.",
	)
	jason_parser.add_argument(
		"--plan-library-asl",
		help=(
